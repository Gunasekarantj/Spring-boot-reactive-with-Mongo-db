...
public class FluxandMonoCombinedTest {
	...
	public void combineUsingMerge_withDelay() {
		...
		Flux<String> mergedFlux = Flux.merge(flux1, flux2);
		StepVerifier.create(mergedFlux.log()).expectSubscription().expectNextCount(6) // .expectNext("A","B","C","D","E","F")
				.verifyComplete();
	...
	public void combineUsingConcat() {
		...
		// .expectNextCount(6) .expectNext("A","B","C","D","E","F") .verifyComplete();
	...
	public void combineUsingZip() {
		...
		StepVerifier.create(mergedFlux.log()).expectSubscription();
		// .expectNextCount(6) .expectNext("AD","BE","CF") .verifyComplete();
