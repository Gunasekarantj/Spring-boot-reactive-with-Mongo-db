...
import static com.learnreactivespring.constansts.ItemConstants.ITEM_END_POINT_V1;
...
public class ItemControllerTest {
    ...
    public void createItem() {
    	Item item = new Item(null,"Iphonen X",999.99);
    	...
    	.jsonPath("$.price").isEqualTo("Iphone X");
